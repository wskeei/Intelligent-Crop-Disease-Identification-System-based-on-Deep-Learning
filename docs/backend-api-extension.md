...
|------|------|--------|----------|------|------|
| B1 | 增强预测接口 (返回 Top-3) | P0 | 2h | - | ✅ 已完成 |
| B2 | 历史记录详情接口 | P1 | 1h | - | ✅ 已完成 |
| B3 | 删除历史记录接口 | P1 | 1h | - | ✅ 已完成 |
| B4 | 批量删除接口 | P1 | 1h | B3 | ✅ 已完成 |
| B5 | 趋势统计接口 | P1 | 3h | - | ✅ 已完成 |
| B6 | 增强统计接口 | P1 | 2h | - | ✅ 已完成 |
| B7 | 病害知识库数据准备 | P2 | 4h | - | 待开发 |
| B8 | 病害知识库列表接口 | P2 | 2h | B7 | 待开发 |
| B9 | 病害详情接口 | P2 | 1h | B7 | 待开发 |
